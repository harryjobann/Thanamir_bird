...
# expecting 669 surveys in both files. the covariates file will show 667 unique IDs
...
cat("T8 entry with missing date (submission ID to check):\n")
print(bad_dates %>% dplyr::select(transect_no, date_cov, submission_id))
...
# collecting everything needed confirmed before diving into analysis.
